...
function InputContact(props){
    ...
    function handleEmptyInfoReservateur(field){
        let reserv = JSON.parse(JSON.stringify(props.reservation.itineraires[props.indiceItineraire].tarifReserves[props.indiceTarifReserver].reservateurWithEmail));
                        ...
                        <div>
                            ...
                            >
                                <div class="input-field">       
                                    <input type="text" value={props.reservation.itineraires[props.indiceItineraire].tarifReserves[props.indiceTarifReserver].reservateurWithEmail.prenom}  
                                ...
                                <div class="input-field">
                                    <input type="text" value={props.reservation.itineraires[props.indiceItineraire].tarifReserves[props.indiceTarifReserver].reservateurWithEmail.nom} onBlur={(e) => handleEmptyInfoReservateur("nom")}
                                ...
                                <div class="input-field">
                                    <input type="text" value={props.reservation.itineraires[props.indiceItineraire].tarifReserves[props.indiceTarifReserver].reservateurWithEmail.tel}
                                ...
                                <div class="input-field input-email">
                                    <input type="text" value={props.reservation.itineraires[props.indiceItineraire].tarifReserves[props.indiceTarifReserver].reservateurWithEmail.email} onBlur={(e) => handleEmptyInfoReservateur("email")}
                            ...
                            <div class="details_reservation">
                                <textarea value={props.reservation.itineraires[props.indiceItineraire].tarifReserves[props.indiceTarifReserver].reservateurWithEmail.messageParticulier}
