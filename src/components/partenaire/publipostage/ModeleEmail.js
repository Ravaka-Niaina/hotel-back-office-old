...
function ModeleEmail(props){
    ...
    return(
        ...
        <>
          ...
          <div class="container" style={{fontFamily:'Roboto,RobotoDraft,Helvetica,Arial,sans-serif',width:800,margin:'0 auto',padding:'0 auto',marginTop:50}}>
                <div class='itineraire' >  
                      ...
                      <div class='reservations' >
                        <div class='reservations_details' style={{marginTop: '1rem',border: '1px solid black'}}>
                            <table style={{marginLeft:'auto',marginRight:'auto',width: '97%'}}>
                                <tr style={{height:15,borderBottom:'1px solid',borderColor:'#f7f7f7'}}>
                                    ...
                                    <td style={{width:190,height:15,textAlign:'center'}}><span style={{fontFamily:'arial,helvetica,sans-serif',fontSize:10}}><strong>Date d'arrivée :</strong></span><br/><span style={{fontFamily:'arial,helvetica,sans-serif',fontSize:10}}>mardi 08 mars 2022</span><br/><span style={{fontFamily:'arial,helvetica,sans-serif',fontSize:10}}><strong>Check-in : 12.00 AM<br/><br/></strong></span></td><br/>
                                ...
                                <tr style={{height:15,borderBottom:'1px solid',borderColor:'#f7f7f7'}}>
                                    ...
                                    <td style={{width:190,height:15,textAlign:'center'}}><span style={{fontFamily:'arial,helvetica,sans-serif',fontSize:10}}><strong>Type de Chambre Réservé</strong></span><br/><span style={{fontFamily:'arial,helvetica,sans-serif',fontSize:10}}>Chambre standard</span><br/></td><br/>
                                ...
                                <tr style={{marginTop: '1rem' ,height:15,backgroundColor:'#f7f7f7'}}>
                      ...
                      <div style={{fontFamily:'arial,helvetica,sans-serif',marginTop: '1rem',marginLeft:'1rem',fontSize:12,color:'#333333',width:588.008}}>
                        <p><span style={{fontSize:10}}>Pour toute question concernant votre réservation, veuillez appeler le département de réservation de "+ hotel.nom+" sur le [telephone de l'hotel] ou envoyer un email au <a href='"+hotel.email+"' target='_blank'>"+hotel.email+"</a><br/><br/></span>Salutations,<br/>[nom de l'hotel]<br/><br/></p>
                      </div>
                </div>
          </div>
        </>
